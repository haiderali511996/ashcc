...
`;a.s(["Toaster",0,({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=((a,b="default")=>{let{toasts:c,pausedAt:d}=((a={},b=u)=>{let[c,d]=(0,e.useState)(y[b]||x),f=(0,e.useRef)(y[b]);(0,e.useEffect)(()=>(f.current!==y[b]&&d(y[b]),w.push([b,d]),()=>{let a=w.findIndex(([a])=>a===b);a>-1&&w.splice(a,1)}),[b]);let g=c.toasts.map(b=>{var c,d,e;return{...a,...a[b.type],...b,removeDelay:b.removeDelay||(null==(c=a[b.type])?void 0:c.removeDelay)||(null==a?void 0:a.removeDelay),duration:b.duration||(null==(d=a[b.type])?void 0:d.duration)||(null==a?void 0:a.duration)||C[b.type],style:{...a.style,...null==(e=a[b.type])?void 0:e.style,...b.style}}});return{...c,toasts:g}})(a,b),f=(0,e.useRef)(new Map).current,g=(0,e.useCallback)((a,b=F)=>{if(f.has(a))return;let c=setTimeout(()=>{f.delete(a),h({type:4,toastId:a})},b);f.set(a,c)},[]);(0,e.useEffect)(()=>{if(d)return;let a=Date.now(),e=c.map(c=>{if(c.duration===1/0)return;let d=(c.duration||0)+c.pauseDuration-(a-c.createdAt);if(d<0){c.visible&&E.dismiss(c.id);return}return setTimeout(()=>E.dismiss(c.id,b),d)});return()=>{e.forEach(a=>a&&clearTimeout(a))}},[c,d,b]);let h=(0,e.useCallback)(B(b),[b]),i=(0,e.useCallback)(()=>{h({type:5,time:Date.now()})},[h]),j=(0,e.useCallback)((a,b)=>{h({type:1,toast:{id:a,height:b}})},[h]),k=(0,e.useCallback)(()=>{d&&h({type:6,time:Date.now()})},[d,h]),l=(0,e.useCallback)((a,b)=>{let{reverseOrder:d=!1,gutter:e=8,defaultPosition:f}=b||{},g=c.filter(b=>(b.position||f)===(a.position||f)&&b.height),h=g.findIndex(b=>b.id===a.id),i=g.filter((a,b)=>b<h&&a.visible).length;return g.filter(a=>a.visible).slice(...d?[i+1]:[0,i]).reduce((a,b)=>a+(b.height||0)+e,0)},[c]);return(0,e.useEffect)(()=>{c.forEach(a=>{if(a.dismissed)g(a.id,a.removeDelay);else{let b=f.get(a.id);b&&(clearTimeout(b),f.delete(a.id))}})},[c,g]),{toasts:c,handlers:{updateHeight:j,startPause:i,endPause:k,calculateOffset:l}}})(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(X,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?Y:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(W,{toast:d,position:j}))}))},"default",0,E],6704)},29338,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(95414);let e=(0,c.createContext)(null);a.s(["AuthProvider",0,function({children:a}){let[f,g]=(0,c.useState)(null),[h,i]=(0,c.useState)(!0);async function j(a,b){let c=await d.default.post("/auth/login",{email:a,password:b});return localStorage.setItem("ashcc_token",c.data.token),localStorage.setItem("ashcc_admin",JSON.stringify(c.data.admin)),g(c.data.admin),c.data.admin}return(0,c.useEffect)(()=>{let a=localStorage.getItem("ashcc_admin");(a&&g(JSON.parse(a)),localStorage.getItem("ashcc_token"))?d.default.get("/auth/me").then(a=>{g(a.data),localStorage.setItem("ashcc_admin",JSON.stringify(a.data))}).catch(()=>{localStorage.removeItem("ashcc_token"),localStorage.removeItem("ashcc_admin"),g(null)}).finally(()=>i(!1)):i(!1)},[]),(0,b.jsx)(e.Provider,{value:{admin:f,loading:h,login:j,logout:function(){localStorage.removeItem("ashcc_token"),localStorage.removeItem("ashcc_admin"),g(null)}},children:a})},"useAuth",0,function(){let a=(0,c.useContext)(e);if(!a)throw Error("useAuth must be used within AuthProvider");return a}])},30383,a=>{"use strict";var b=a.i(87924);a.s(["default",0,function({variant:a="dark",className:c=""}){return(0,b.jsxs)("div",{className:`flex items-center gap-3 ${c}`,children:[(0,b.jsx)("span",{className:`flex h-10 w-10 shrink-0 items-center justify-center rounded-full ${"light"===a?"bg-white p-1":""}`,children:(0,b.jsx)("img",{src:"/logo-icon.png",alt:"Al Sadiq Health Care Centre logo",className:"h-full w-full object-contain"})}),(0,b.jsxs)("div",{className:"leading-tight",children:[(0,b.jsx)("p",{className:`text-lg font-bold tracking-wide ${"light"===a?"text-white":"text-ink-900"}`,children:"AL SADIQ"}),(0,b.jsx)("p",{className:`text-[10px] font-semibold uppercase tracking-[0.2em] ${"light"===a?"text-white/70":"text-ink-500"}`,children:"Health Care Centre"})]})]})}])},44914,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(95414);let e=(0,c.createContext)(null),f={siteName:"Al Sadiq Health Care Centre",tagline:"Compassionate Care, Trusted Excellence",aboutText:"",mission:"",vision:"",address:"Lahore, Pakistan",phone:"",whatsapp:"",email:"",mapEmbedUrl:"",openingHours:"",facebook:"",instagram:"",twitter:"",youtube:""};a.s(["SettingsProvider",0,function({initialSettings:a,children:g}){let[h,i]=(0,c.useState)({...f,...a});return(0,b.jsx)(e.Provider,{value:{settings:h,refreshSettings:function(){return d.default.get("/settings").then(a=>i({...f,...a.data}))}},children:g})},"defaultSettings",0,f,"useSettings",0,function(){let a=(0,c.useContext)(e);if(!a)throw Error("useSettings must be used within SettingsProvider");return a}])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0zjn8fq._.js.map