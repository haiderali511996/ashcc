...
export const metadata = {
  title: 'About Us',
  description:
    'Learn about Al Sadiq Health Care Centre (ASHCC) in Lahore, Pakistan — our mission, vision, and commitment to compassionate, quality healthcare.',
};
      ...
      <section className="section">
        <div className="container-app grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="section-title">{settings?.siteName || 'Al Sadiq Health Care Centre'}</h2>
